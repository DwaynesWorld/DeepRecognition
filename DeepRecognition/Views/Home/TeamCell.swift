...
class TeamCell: BaseCell {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            departmentCount.leftAnchor.constraint(equalTo: leftAnchor, constant: 15),
            departmentCount.rightAnchor.constraint(equalTo: rightAnchor, constant: -15),
        ...
        NSLayoutConstraint.activate([
            ...
            departmentName.leftAnchor.constraint(equalTo: leftAnchor, constant: 15),
            departmentName.rightAnchor.constraint(equalTo: rightAnchor, constant: -15),
        ...
        NSLayoutConstraint.activate([
            ...
            recognitionsLastWeekCount.leftAnchor.constraint(equalTo: leftAnchor, constant: 15),
            recognitionsLastWeekCount.rightAnchor.constraint(equalTo: rightAnchor, constant: -15),
        ...
        NSLayoutConstraint.activate([
            ...
            recognitionsByYouCount.leftAnchor.constraint(equalTo: leftAnchor, constant: 15),
            recognitionsByYouCount.rightAnchor.constraint(equalTo: rightAnchor, constant: -15),
